...
regression_ready_df <- mega_combined_vars_df_final %>%
  ...
  make.pbalanced()
#-----------------------------------------------------------------------------------------------
form_m1.1 <- wid_pre_tax_income_share_top_0.1pct ~
  cpds_inflation_rate +
  oecd_union_density +
  piketty_ratio +
  interest_rate_short_terme +
...
form_m1.2 <- wid_pre_tax_income_share_top_0.1pct ~
  cpds_inflation_rate +
  oecd_union_density +
  piketty_ratio +
  interest_rate_short_terme +
...
form_m1.3 <- wid_pre_tax_income_share_top_0.1pct ~
  cpds_inflation_rate +
  oecd_union_density +
  piketty_ratio +
  interest_rate_short_terme +
...
form_m1.4 <- wid_pre_tax_income_share_top_0.1pct ~
  cpds_inflation_rate +
  oecd_union_density +
  piketty_ratio +
  interest_rate_short_terme +
